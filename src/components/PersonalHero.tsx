...
const PersonalHero = () => {
  ...
  const linkGroups: { title: string; url?: string; isInternal?: boolean; links: { name: string; url: string; isInternal?: boolean }[] }[] = [
    ...
    },
    {
      ...
      links: [
        { name: "Topical Steroid Withdrawal in the FAERS  (2026)", url: "https://substack.com/home/post/p-202689171" },
        ...
        { name: "Disproportionality in Special Education (2021)", url: "https://drive.google.com/file/d/1G_Z_lS5vOB2svHczmLFfYPvzxMHjuKL8/view?usp=sharing" },
