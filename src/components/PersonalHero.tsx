...
const PersonalHero = () => {
  ...
  const linkGroups: { title: string; url?: string; isInternal?: boolean; links: { name: string; url: string; isInternal?: boolean }[] }[] = [
    ...
    },
    {
      ...
      links: [
        { name: "Architecture of Invisibility: Topical Steroid Withdrawal in the FAERS  (2026)", url: "https://substack.com/home/post/p-202689171" },
        { name: "Medicaid Provider Spending Dataset and the Trump Administration (2026)", url: "https://substack.com/home/post/p-191308941" },
        { name: "How GPT supported me through Topical Steroid Withdrawal (2025)", url: "https://substack.com/home/post/p-188758463" },
        { name: "Topical Steroids in the 2020s (2025)", url: "https://substack.com/home/post/p-174214583" },
        { name: "Post 2000s Topical Steroids (2025)", url: "https://substack.com/home/post/p-162510124" },
        { name: "The Uneven Histories of Oral and Topical Steroids (2025)", url: "https://substack.com/home/post/p-162236531" },
        { name: "CalPERS & CalSTRS Fossil Fuel Divestment Bill Policy Memo (2021)", url: "https://docs.google.com/document/d/1C89XV4XzcNxcmakv8P9ARSaB9tfGEeXWOn58K-bf3zI/edit?usp=sharing" },
        { name: "Successful Partnerships Between Human Service Nonprofits and Healthcare Organizations (2021)", url: "https://insights.theberkeleygroup.org/successful-partnerships-between-human-service-nonprofits-and-healthcare-organizations-619490f90593" },
        { name: "Racial Gaps in Classroom Disability Identification (2021)", url: "https://drive.google.com/file/d/1YyodN3MGN-mq2MWmPXvTXM8jgF1BVCJP/view?usp=sharing" },
        { name: "The Pitfalls of Housing First and the Pay-For-Success Model (2020)", url: "https://drive.google.com/file/d/1DDqhQKQzRKzfRuB0swJNclZLRqRStrXM/view?usp=sharing" },
      ],
    },
    {
      title: "Art",
